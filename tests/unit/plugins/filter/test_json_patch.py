...
import unittest
import json
from ansible_collections.numo68.general.plugins.filter.json_patch import FilterModule
...
class TestJsonPatch(unittest.TestCase):
    ...
    def test_missing_lib(self):
        with unittest.mock.patch(
            "ansible_collections.numo68.general.plugins.filter.json_patch.HAS_LIB",
            False,
        ):
